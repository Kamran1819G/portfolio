    ...
    <>
        ...
        <Container>
          <Row className="justify-content-around">
            <Col lg={6}>
              ...
              <a className="scroll mt-5" href="#projects-section">
            ...
            <Col className="intro-images">
              ...
              <svg
                ...
                className="blob animate__animated animate__zoomInUp animate__delay-1s"
              >
                <defs>
                  <linearGradient id="sw-gradient" x1={0} x2={1} y1={1} y2={0}>
                    <stop
                      id="stop1"
                      stopColor="rgba(138, 116, 184, 1)"
                      offset="0%"
                    />
                    <stop
                      id="stop2"
                      stopColor="rgba(164, 132, 203, 1)"
                      offset="100%"
                    />
                  </linearGradient>
                </defs>
                <path
                  ...
                  d="M12.8,-4.1C20.9,0,34.7,5.5,35.8,11.2C37,16.9,25.4,22.8,14.3,27.2C3.2,31.7,-7.5,34.7,-16.2,31.3C-24.9,28,-31.7,18.4,-29.8,11.2C-27.9,4,-17.4,-0.7,-11,-4.4C-4.6,-8,-2.3,-10.5,0,-10.5C2.3,-10.6,4.7,-8.1,12.8,-4.1Z"
                  width="100%"
                  height="100%"
          ...
          <div className="mt-5">
            <Slider {...settings}>
              <ProjectCard
                ...
                techStack={["dart", "flutter", "firebase", "react"]}
              />
              <ProjectCard
                title="Algopedia"
                img={Algopedia}
      ...
      <section className="skill-section my-5 py-5">
        <Container>
          ...
          <Row className="justify-content-around">
            <div className="skillBox" data-aos="zoom-in" data-aos-delay="100">
              <p>HTML5</p>
              <p>100%</p>
              <div className="skill">
            ...
            <div className="skillBox" data-aos="zoom-in" data-aos-delay="100">
              ...
              <p>20%</p>
              <div className="skill">
                <div className="skill_level" style={{ width: "20%" }}></div>
              </div>
            </div>
            <div className="skillBox" data-aos="zoom-in" data-aos-delay="100">
              <p>JSON</p>
            ...
            <div className="skillBox" data-aos="zoom-in" data-aos-delay="100">
              ...
              <p>40%</p>
              <div className="skill">
                <div className="skill_level" style={{ width: "40%" }}></div>
              </div>
            </div>
            <div className="skillBox" data-aos="zoom-in" data-aos-delay="100">
              <p>C</p>
